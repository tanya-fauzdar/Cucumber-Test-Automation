...
public class BasePage {
	...
	/*
	 * This class contains sommon driver reference which will be shared among all
	 * other page classes that will extend this Base Class.
	 */
	...
	public static BaseCarPage baseCar;
	...
	public BasePage(WebDriver driver) {
		...
		baseCar = new BaseCarPage();

	}

	/*
	 * We will be creating key-words [methods] for general actions like we did
	 * earlier ex: click(), type(), isElementPresent(), scroll(), mouseHover() etc
	 */
	public void mouseHover(String locator) {
		...
		if (locator.endsWith("_XPATH")) {
			...
			mouseHoverElement = driver
					.findElement(By.partialLinkText(SeleniumDriver.OR.getProperty("newCarmenu_PARTIALLINK")));
	...
	public static void click(String locatorKey) {
		...
		if (locatorKey.endsWith("_XPATH")) {
			// System.out.println("Tanya-----BasePage -> locating 'Find new cars' Web
			// element now");
			SeleniumDriver.waitDriver.until(ExpectedConditions
					.presenceOfElementLocated((By.xpath((SeleniumDriver.OR.getProperty(locatorKey)))))).click();
			// System.out.println("Tanya-----BasePage class -> Title now is: " +
			// driver.getTitle());
			...
			SeleniumDriver.waitDriver
					.until(ExpectedConditions
							.presenceOfElementLocated((By.linkText((SeleniumDriver.OR.getProperty(locatorKey))))))
					.click();
	...
	public static String getText(String locatorKey) {
		// System.out.println("Tanya---- inside BasePage-> getText() and Locator key is:
		// " + locatorKey);

		if (locatorKey.endsWith("_XPATH")) {
			/*
			 * System.out.
			 * println("Tanya---- inside BasePage-> for Toyota page's carTitle()-> getText() XPATH"
			 * );
			 * 
			 * WebElement locator =
			 * driver.findElement((By.xpath((SeleniumDriver.OR.getProperty(locatorKey)))));
			...
			// System.out.println("Tanya------ The Car Title is : " + title.getText());
			...
			locatorKey = driver.findElement((By.partialLinkText((SeleniumDriver.OR.getProperty(locatorKey)))))
					.getText();
		}
